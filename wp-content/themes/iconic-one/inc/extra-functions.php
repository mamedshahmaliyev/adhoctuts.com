...
function iop_social_icons() { ?>
		<div class="socialmedia">
			...
			<a class="rss" href="<?php echo esc_url( get_theme_mod( 'youtube_url', 'default_value' ) ); ?>" target="_blank"><img src="<?php echo esc_url( get_template_directory_uri()); ?>/img/youtube.png" alt="Follow us on Youtube"/></a>			
			<?php } ?>
		</div>
		<?php }
?>